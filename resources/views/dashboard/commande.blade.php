...
<head>
  ...
  <title>L'ESTIME | Tous les commandes </title>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="addproduct.html" class="menu-link">
                  <div data-i18n="Without menu">Ajouter produit</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="update-product.html" class="menu-link">
                  <div data-i18n="Without menu">Modifier produit</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="liste-product.html" class="menu-link">
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link">
              ...
              <div data-i18n="Form Layouts">Statistique de client</div>
            </a>
        ...
        <!-- / Navbar -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Commande /</span> Tous les Commandes</h4>
