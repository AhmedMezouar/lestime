...
* Product Page: ##/products/sneat-bootstrap-html-admin-template/
...
>
  <head>
    ...
    <title>L'ESTIME | Tableaux de Bord</title>
  ...
  <body>
                    ...
                    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                      <g id="Icon" transform="translate(27.000000, 15.000000)">
                        <g id="Mask" transform="translate(0.000000, 8.000000)">
                          ...
                          <use fill="#ffc711" xlink:href="#path-1"></use>
                          <g id="Path-3" mask="url(#mask-2)">
                            <use fill="#ffc711" xlink:href="#path-3"></use>
                            <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-3"></use>
                          </g>
                          <g id="Path-4" mask="url(#mask-2)">
                            <use fill="#ffc711" xlink:href="#path-4"></use>
                        ...
                        >
                          <use fill="#ffc711" xlink:href="#path-5"></use>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="/dashboard" class="menu-link">
                ...
                <div data-i18n="Analytics">Tableaux de Bord</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{route('dashboard.commande.filter',['etat'=>6])}}" class="menu-link">
            ...
            <!-- Forms -->
            <li class="menu-item">
              <a href="{{route('dashboard.state.client')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{route('dashboard.state.produit')}}" class="menu-link">
                ...
                <div data-i18n="Tables">Statistique de Produit</div>
              </a>
            </li>
            <!-- Misc -->
            ...
            <li class="menu-item">
              ...
              >
                ...
                <div data-i18n="Support">Votre Boutique</div>
              </a>
            </li>
          </ul>
        </aside>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        ...
                        <span class="align-middle">La page web</span>
                      </a>
                    </li>
                    <li>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="##" target="_blank" class="footer-link fw-bolder">Golden Ideas & Bleu Star</a>
                </div>
    ...
    <script>
      ...
      document.getElementById('inputpromo').addEventListener("keyup", function (evt) {
        
        console.log(this.value)
        if (!this.value.trim().length) {

          console.log(document.getElementById("inputnvprix").value);
        console.log(document.getElementById("input_prix_ht").value);
        
        taux = 0;
        document.getElementById("inputnvprix").value = parseFloat(document.getElementById("inputoldprix").value) - taux;
        
        document.getElementById("tauxpromo").value = taux;
           console.log(this.value);
        }
        else {
        console.log(document.getElementById("inputnvprix").value);
        console.log(document.getElementById("input_prix_ht").value);
        var taux = 100 - (parseFloat(document.getElementById("input_prix_ht").value) * parseFloat(this.value)) / 100;
        taux = taux *-1;
        document.getElementById("inputnvprix").value = parseFloat(document.getElementById("inputoldprix").value) - taux;
        document.getElementById("inputnvprix2").value = parseFloat(document.getElementById("inputoldprix").value) - taux;
