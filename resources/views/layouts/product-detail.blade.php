                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    ...
                                    <div class="input-commande">
                                        <input class="input2 plh1 stext-107 cl7" type="text" name="nom" placeholder="Nom Prenom">
                                        <input class="input2 plh1 stext-107 cl7" type="text" name="number" placeholder="Numero de téléphone">
                                        <input class="input2 plh1 stext-107 cl7" type="text" name="email" placeholder="E-mail">
                                        <input class="input2 plh1 stext-107 cl7" type="text" name="wilaya" placeholder="Wilaya">
