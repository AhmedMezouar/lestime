...
<body class="animsition">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			<a href="/ecommerce" class="stext-109 cl8 hov-cl1 trans-04">
				Acceuil
						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="column-3">3750.00 DA</td>
									<td class="column-4">
									...
									<td class="column-5">3750.00 DA</td>
								</tr>
								...
								<tr class="table_row">
									...
									<td class="column-3">1750.00 DA</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
												<i class="fs-16 zmdi zmdi-minus"></i>
									...
									<td class="column-5">1750.00 DA</td>
								</tr>
							</table>
						</div>
								...
								<div class="p-t-15">
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="wilaya">
											<option>Selectionner votre wilaya...</option>
											<option>Adrar</option>
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="livraison">
											...
											<option>Livraison Stop Desk</option>
										</select>
										<div class="dropDownSelect2"></div>
									</div>
									<div class="flex-w">
